...
CREATE TABLE Empleado (
  ...
  rol ENUM('admin', 'peluquero', 'recepcionista', 'cajero') NOT NULL,
...
CREATE TABLE Turno (
  ...
  -- Restricción para que solo los empleados con rol de 'peluquero' puedan ser empleados asignados.
  FOREIGN KEY (empleado_id) REFERENCES Empleado(id) ON DELETE SET NULL
);

-- -----------------------------------------------------------
-- 5. Tabla de Unión: Turno_Servicio (Muchos a Muchos)
